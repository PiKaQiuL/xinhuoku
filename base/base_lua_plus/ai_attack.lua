function base.ai_attack_add_team_threat(ai_attack, team, threat)
 ...
 ---@keyword 仇恨 队伍
function base.ai_attack_add_unit_threat(ai_attack, unit, threat)
 ...
 ---@keyword 仇恨 单位
function base.ai_attack_add_type_threat(ai_attack, unit_tag, threat)
 ...
 ---@keyword 仇恨 标签
function base.ai_attack_remove(ai_attack)
    ---@ui 移除搜敌器~1~
    ---@belong ai
    ---@description 移除搜敌器
    ---@applicable action
