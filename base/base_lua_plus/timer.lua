function base.timer_clock()
 ...
 ---@keyword 游戏 时间
function base.timer_remove(timer)
    ---@ui 移除计时器~1~
    ---@belong timer
    ---@description 移除计时器
    ---@applicable action
 ...
 ---@keyword 移除 计时器
function base.timer_resume(timer)
    ---@ui 恢复计时器~1~
    ---@belong timer
    ---@description 恢复计时器
    ---@applicable action
 ...
 ---@keyword 恢复 计时器
function base.timer_pause(timer)
    ---@ui 暂停计时器~1~
    ---@belong timer
    ---@description 暂停计时器
    ---@applicable action
 ...
 ---@keyword 暂停 计时器
function base.timer_restart(timer)
    ---@ui 重启计时器~1~
    ---@belong timer
    ---@description 重启计时器
    ---@applicable action
 ...
 ---@keyword 重启 计时器
function base.timer_sleep(time)
    ---@ui 等待~1~秒
    ---@belong timer
    ---@description 等待一段时间
    ---@applicable action
 ...
 ---@keyword 等待 时间
function base.timer_wait(time, func)
    ---@ui 等待~1~秒后执行~2~
    ---@belong timer
 ...
 ---@keyword 等待 执行
function base.timer_loop(time, func)
    ---@ui 每~1~秒执行~2~
    ---@belong timer
 ...
 ---@keyword 循环 执行
function base.timer_timer(time, times, func)
