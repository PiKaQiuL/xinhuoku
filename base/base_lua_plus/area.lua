function base.get_scene_circle(scene, area_name, present)
    ---@ui 场景~1~的圆~2~
    ---@belong 圆
    ...
    ---@name2 区域名
    ---@name3 全局表
    local circle = (present[scene] and present[scene]['circle'][area_name])
    if circle then
        circle.scene = (circle.scene or scene)
    end
    return circle
end

function base.get_scene_rect(scene, area_name, present)
    ---@ui 场景~1~的矩形~2~
    ---@belong 矩形
    ...
    ---@name2 区域名
    ---@name3 全局表
    local rect = (present[scene] and present[scene]['rect'][area_name])
    if rect then
        rect.scene = (rect.scene or scene)
    end
    return rect
end
...
function base.circle_get_point(circle)
    ---@ui ~1~的圆心
    ---@belong area
    ---@description 圆心
    ---@applicable value
...
function base.circle_get_range(circle)
    ---@ui ~1~的半径
    ---@belong area
    ---@description 圆的半径
    ---@applicable value
...
function base.circle_random_point(circle)
    ---@ui ~1~内的随机点
    ---@belong area
    ---@description 圆内的随机点
    ---@applicable value
...
function base.rect_get_point(rect)
    ---@ui ~1~的中心点
    ---@belong area
    ---@description 矩形的中心点
    ---@applicable value
...
function base.rect_get_width(rect)
    ---@ui ~1~的宽度
    ---@belong area
...
function base.rect_get_height(rect)
    ---@ui 矩形~1~的高度
    ---@belong area
...
function base.rect_random_point(rect)
    ---@ui ~1~内的随机点
    ---@belong area
    ---@description 矩形内的随机点
    ---@applicable value
...
function base.get_random_point(area)
    ---@ui ~1~内的随机点
    ---@belong area
    ---@description 区域内的随机点
    ---@applicable value
...
function base.get_area_point(area)
    ---@ui ~1~的中心点
    ---@belong area
    ---@description 区域的中心点
    ---@applicable value
    ---@name1 矩形
    if (area_check(area, true)) then
        return area:get_scene_point()
    end
end

function base.get_scene_scale_area(scene_name)
    ---@ui 场景~1~的整个区域
    ---@belong area
    ---@description 场景的整个区域
    ---@applicable value
...
function base.get_area_unit_group(area, 过滤条件)
...
function base.get_area_type_unit(area, unit_id_name)
    ---@ui ~1~内Id为~2~的单位
    ---@belong area
...
function base.get_area_type_unit_group(area, unit_id_name, 过滤条件)
...
function base.get_area_player_type_unit(area, player, unit_id_name)
...
function base.get_area_player_type_unit_group(area, player, unit_id_name, 过滤条件)
...
function base.is_point_in_rect(point, rect)
    ...
    if rect_check(rect) then
        ...
        local rx, ry = rect:get_scene_point():get_xy()
