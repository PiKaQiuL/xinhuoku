...
function base.damage_get_damage(damage)
    ---@ui ~1~的原始伤害值
    ---@belong unit
 ...
 ---@keyword 伤害
function base.damage_get_current_damage(damage)
    ---@ui ~1~的当前伤害值
    ---@belong unit
 ...
 ---@keyword 伤害
function base.damage_set_current_damage(damage, amount)
    ---@ui 设置~1~的当前伤害值为~2~
    ---@belong unit
 ...
 ---@keyword 伤害
function base.do_trigger_damage(source, target, amount, damage_type)
    ...
    ---@name4 伤害类型
    ---@arg1 "物理"
    if (unit_check(source) and unit_check(target)) then
