--- lua_plus ---
for player:unknown in base.each_player() do
    player.component = {}
end
local component_name:unknown = {} --[[ k = name, v = component]]

function base.get_last_created_component()simple_component
    ---@ui 触发器最后创建的简易控件
...
function base.component_position(x:number, y:number)position
    ---@ui x：~1~，y：~2~
    ---@belong simple_component
    ---@description 简易控件位置
    ---@applicable value
 ...
 ---@keyword 简易控件 位置
function base.component_size(width:number, height:number)size
    ---@ui 宽：~1~，高：~2~
    ---@belong simple_component
    ---@description 简易控件尺寸
    ---@applicable value
 ...
 ---@keyword 简易控件 尺寸
function base.component_color(r:number, g:number, b:number)color
    ---@ui r：~1~，g：~2~，b：~3~
    ---@belong simple_component
    ---@description 简易控件染色
    ---@applicable value
 ...
 ---@keyword 简易控件 染色
---------------------------------创建-------------------------------------
function base.create_component_button(position:position, size:size, text:string, visiblity:可见性, event_label:string)simple_component
    ...
    local component_id:unknown = # base.player(1).component + 1
    local msg:unknown = {
 ...
 ---@keyword 按钮 创建
function base.create_component_picture(position:position, size:size, image:string, visiblity:可见性, event_label:string)simple_component
 ...
 ---@keyword 按钮 创建
function base.create_component_text(position:position, size:size, text:string, font_size:number, visiblity:可见性, event_label:string)simple_component
...
---------------------------------移除-------------------------------------
function base.destroy_component(component_id:simple_component)
    ---@ui 移除~1~
    ---@belong simple_component
    ---@description 移除简易控件
    ---@applicable action
...
function base.set_component_position(player:player, component_id:simple_component, position:position)
    ---@ui 设置~1~的~2~位置为~3~
    ---@belong simple_component
 ...
 ---@keyword 设置 简易控件 位置
function base.set_component_size(player:player, component_id:simple_component, size:size)
    ---@ui 设置~1~的~2~尺寸为~3~
    ---@belong simple_component
 ...
 ---@keyword 设置 简易控件 尺寸
function base.set_component_visiblity(component_id:simple_component, player:player, visiblity:可见性)
    ---@ui 令~1~对~2~~3~
    ---@belong simple_component
 ...
 ---@keyword 设置 简易控件 可见性
function base.set_component_color(player:player, component_id:simple_component, color:color)
    ---@ui 为~1~的~2~染色，数值为~3~
    ---@belong simple_component
 ...
 ---@keyword 设置 简易控件 染色
function base.set_component_can_be_clicked(player:player, component_id:simple_component, can_be_clicked:是否)
    ---@ui 设置~1~的~2~~3~可被点击
    ---@belong simple_component
    ...
    ---@arg3 base.player(1)
    if component_check(component_id) then
        local component_type:unknown = player.component[component_id].type
...
function base.set_component_text(player:player, component_id:simple_component, text:string)
    ---@ui 设置~1~的~2~文本为~3~
    ---@belong simple_component
 ...
 ---@keyword 设置 简易控件 文本
function base.set_component_font_size(player:player, component_id:simple_component, font_size:number)
    ---@ui 设置~1~的~2~字号为~3~
    ---@belong simple_component
 ...
 ---@keyword 设置 简易控件 字号
function base.set_component_image(player:player, component_id:simple_component, image:string)
    ---@ui 设置~1~的~2~图片为~3~
    ---@belong simple_component
 ...
 ---@keyword 设置 简易控件 图片
function base.set_component_opacity(player:player, component_id:simple_component, opacity:number)
...
function base.set_component_zoom_type(player:player, component_id:simple_component, zoom_type:图片缩放方式)
...
function base.set_component_auto_line_feed(player:player, component_id:simple_component, auto_line_feed:是否)
...
function base.set_component_text_align(player:player, component_id:simple_component, align:横向对齐方式)
...
function base.set_component_text_vertical_align(player:player, component_id:simple_component, vertical_align:纵向对齐方式)
...
function base.get_component_position(player:player, component_id:simple_component)position
    ---@ui ~1~的~2~位置
    ---@belong simple_component
 ...
 ---@keyword 简易控件 位置
function base.get_component_size(player:player, component_id:simple_component)size
    ---@ui ~1~的~2~尺寸
    ---@belong simple_component
 ...
 ---@keyword 简易控件 尺寸
function base.get_component_visiblity(component_id:simple_component, player:player)boolean
    ---@ui ~1~是否对~2~可见
    ---@belong simple_component
...
function base.get_component_color(player:player, component_id:simple_component)string
    ---@ui ~1~的~2~染色参数
    ---@belong simple_component
 ...
 ---@keyword 简易控件 染色
function base.get_component_can_be_clicked(player:player, component_id:simple_component)boolean
    ---@ui ~1~的~2~是否可被点击
    ---@belong simple_component
 ...
 ---@keyword 简易控件 可被点击
function base.get_component_text(player:player, component_id:simple_component)string
    ---@ui ~1~的~2~文本
    ---@belong simple_component
 ...
 ---@keyword 简易控件 文本
function base.get_component_font_size(player:player, component_id:simple_component)string
    ---@ui ~1~的~2~字号
    ---@belong simple_component
 ...
 ---@keyword 简易控件 字号
function base.get_component_image(player:player, component_id:simple_component)string
    ---@ui ~1~的~2~图片
    ---@belong simple_component
 ...
 ---@keyword 简易控件 图片
function base.get_component_opacity(player:player, component_id:simple_component)number
    ---@ui ~1~的~2~不透明度
    ---@belong simple_component
 ...
 ---@keyword 简易控件 不透明度
function base.get_component_zoom_type(player:player, component_id:simple_component)图片缩放方式
    ---@ui ~1~的~2~图片缩放方式
    ---@belong simple_component
...
function base.get_component_auto_line_feed(player:player, component_id:simple_component)boolean
    ---@ui ~1~的~2~文本是否自动换行
    ---@belong simple_component
...
function base.get_component_text_align(player:player, component_id:simple_component)横向对齐方式
    ---@ui ~1~的~2~文本横向对齐方式
    ---@belong simple_component
 ...
 ---@keyword 简易控件 文本 对齐
function base.get_component_text_vertical_align(player:player, component_id:simple_component)纵向对齐方式
    ---@ui ~1~的~2~文本纵向对齐方式
    ---@belong simple_component
...
base.ui.proto.component_event = function(player:unknown, msg:unknown)
