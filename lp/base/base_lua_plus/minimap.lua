--- lua_plus ---
function base.create_icon(player:player, name:unit_id, point:point)icon
    ...
    if player:get_scene_name() ~= point:get_scene() then
        ...
        local icon:unknown = base.minimap.icon(player, name, point)
        if icon then
            icon.type = "icon"
            return icon
        end
 ...
 ---@keyword 地图 图标
function base.icon_set_sync(icon:icon, sync:同步方式)
    ---@ui 设置~1~的同步方式为~2~
    ---@belong minimap
 ...
 ---@keyword 图标 同步
function base.icon_hide(icon:icon)
    ---@ui 隐藏~1~
    ---@belong minimap
    ---@description 隐藏小地图图标
    ---@applicable action
 ...
 ---@keyword 图标 隐藏
function base.icon_hide_team(icon:icon, team:integer)
 ...
 ---@keyword 图标 隐藏
function base.icon_show(icon:icon)
    ---@ui 显示~1~
    ---@belong minimap
    ---@description 显示小地图图标
    ---@applicable action
 ...
 ---@keyword 图标 显示
function base.icon_set_time(icon:icon, time:number)
    ---@ui 设置~1~的持续时间为~2~秒
    ---@belong minimap
 ...
 ---@keyword 图标 时间
function base.minimap_signal(player:player, name:string, point:point)
